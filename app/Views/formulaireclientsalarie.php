...
<body>
    ...
    <div class="choix_client">
        ...
        <form id="saisie_id_client" action="{$url_base}RechercheClientSalarie/rechercheClient" method="POST">
 ...
 <!-- <div class="container">
    ...
    <div class="row">
      <div class="col-md-4"> -->
        <form action="<?php echo base_url('public/Clientsalarie/addclientsalarie');?>" name="form_compte_non_salarie" id="form_compte_non_salarie" method="post" accept-charset="utf-8">
...
<script type="text/javascript" src="<?php echo base_url('js/script.js'); ?>"></script>
 <!-- <script>
   if ($("#addClientNonSalarie").length > 0) {
      $("#addClientNonSalarie").validate({
