...
<body>
 ...
 <!-- <div class="container">
    ...
    <div class="row">
      <div class="col-md-4"> -->
        <form action="<?php echo base_url('public/Clientnonsalarie/addclientnonsalarie');?>" name="form_compte_non_salarie" id="form_compte_non_salarie" method="post" accept-charset="utf-8">
