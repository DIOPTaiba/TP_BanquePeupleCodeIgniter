...
<body>
    ...
    <div id="page_authentification">
        ...
        <form id="formulaire_admin" action="<?php echo base_url('public/AuthentificationEmployes/verifieAdmin');?>" method="POST" onsubmit="return controle_champs_admin()">
            <fieldset>
                <legend>
        ...
        <form id="formulaire_responsable" action="<?php echo base_url('public/AuthentificationEmployes/verifieResponsable');?>" method="POST" onsubmit="return controle_champs_responsable()">
            <fieldset>
                <legend>
        ...
        <form id="formulaire_caissiere" action="<?php echo base_url('public/AuthentificationEmployes/verifieCaissiere');?>" method="POST" onsubmit="return controle_champs_caissiere()">
            <fieldset>
                <legend>
